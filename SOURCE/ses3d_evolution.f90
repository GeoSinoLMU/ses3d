...
include 'mpif.h'
    ...
    vx_global=taper_global*vx_global
    vy_global=taper_global*vy_global
    vz_global=taper_global*vz_global

    sxx_pml=sxx_pml*taper
    syy_pml=syy_pml*taper
    szz_pml=szz_pml*taper
    sxy_pml=sxy_pml*taper
    syx_pml=syx_pml*taper
    szx_pml=szx_pml*taper
    sxz_pml=sxz_pml*taper
    syz_pml=syz_pml*taper
    szy_pml=szy_pml*taper
