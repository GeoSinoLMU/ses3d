...
implicit none
    ...
    integer, parameter :: maxnt=50000       ! maximum number of time steps
    integer, parameter :: maxnr=1000        ! maximum number of receivers
    ...
    ! PML_LIMIT: 
    !     -1        set ispml to 1 for all iterations
    !      0        set ispml to 0 for all iterations
    !      N > 0    set ispml to 1 for the firsr N iterations, then set it to 0

    integer, parameter :: PML_LIMIT = 0

    ! diagnostic switches (0=disable, 1=enable)

    integer, parameter :: USE_DIAG_MODEL = 0
    integer, parameter :: USE_DIAG_FW = 0
    integer, parameter :: USE_DIAG_GRAD = 0
...
implicit none
    ...
    character (len=64), dimension(1:1000) :: event_indices
